...
import static org.amdatu.ide.templating.AmdatuIdeModuleBuilder.KEY_ATTRS;
import static org.amdatu.ide.templating.AmdatuIdeModuleBuilder.KEY_TEMPLATE;

class AmdatuIdeModuleTemplateParamsStep extends ModuleWizardStep {

    private List<Consumer<Map<String, List<Object>>>> attrUpdaters = new ArrayList<>();

    private WizardContext myContext;

    AmdatuIdeModuleTemplateParamsStep(WizardContext context) {
        myContext = context;
    }
